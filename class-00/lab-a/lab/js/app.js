...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT // Because its scope exist in while statment 
  // and the line 38 is out side its scope because its will console.log the globals
  console.log(viewed);
