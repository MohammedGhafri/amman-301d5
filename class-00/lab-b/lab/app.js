...
console.log(newSum(1, 2, 3, 4));//new
...
console.log(newSumAndProduct(3, 9));//new
...
console.log(newMessage('Allie'));//new
...
// let joe2 = new Newstudent('Joe', 'Schmoe', 100);
...
// It console the object because "this" is with its scope

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scope());// It console the object because "this" is with its scope

Student.prototype.scopeArrow = () => console.log(this);

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scopeArrow());// It will console the global window object

// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?

// the object which is "Student {name: "Joe", age: "Schmoe", hometown: 100}"
